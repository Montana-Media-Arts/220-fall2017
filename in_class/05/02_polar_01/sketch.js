...
function setup() {
    ...
    objs.push(
        new Spiral( width/2, height/2, 0, 10, 64, 'clockwise', 'rgba(207, 52, 221, 0.69)' )
    );



    objs.push(
        new Spiral( width/2, height/2, PI, 10, 64, 'clockwise', 'rgba(52, 221, 170, 0.69)' )
    );
}
...
function Spiral( x, y, offset, diam, rot_delta, dir, color ) {
...
Spiral.prototype.update = function(){
    this.cart.x = this.pos.r * cos(this.pos.theta + this.offset);
    this.cart.y = this.pos.r * sin(this.pos.theta + this.offset);
